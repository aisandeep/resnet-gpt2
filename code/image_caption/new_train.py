...
# data_folder = "/home/dev.narayanan/pubtabep/im_train_dir"
data_folder = r'C:\Users\sande\OneDrive\Desktop\res+gpt\table-recognition\code\image_caption\dataset'
data_folder1 = r'C:\Users\sande\OneDrive\Desktop\res+gpt\table-recognition\code\image_caption\output'
# Model parameters
...
def train(train_loader, encoder, decoder_structure, decoder_cell, criterion_structure, criterion_cell, encoder_optimizer, decoder_structure_optimizer, decoder_cell_optimizer, epoch):
    ...
    LOG_FILE = '/home/dev.narayanan/pubtabep/train_logs.json'
    ...
    for i, (imgs, caption_structures, caplen_structures, caption_cells, caplen_cells, number_cell_per_images) in enumerate(train_loader):
        ...
        # print('caption_structures')
        # print(caption_structures)
        caplen_structures = caplen_structures.to(device)
        print('caplen_structures')
        print(caplen_structures)
